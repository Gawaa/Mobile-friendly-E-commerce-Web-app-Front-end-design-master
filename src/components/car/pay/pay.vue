<template lang="html">
  ...
  <div class="pay">
    <v-header>
      <h1 slot="title">Checkout</h1>
    </v-header>

    <div class="pay-address">
      <div>
        <p class="main-address-per"><span>Gawa</span></p>
        <p class="main-address-tel">831-XXX-YYYY</p>
      </div>
      <p>Address:<span>1156 High St, Santa Cruz, CA 95064</span></p>
    </div>
    ...
    <div class="pay-product">
      ...
      <div class="pay-confirm" v-else>
        ...
        Data is clean</br>
        Resting Shopping car
      </div>
    </div>
    <h3 class="pay-allpay">order total : <i>$</i><span>{{allpay}}</span></h3>
